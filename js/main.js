const T = {
  en: {
        nav_about:'About',
    s0_label:'// 00 — ABOUT',
    about_lead:'Java backend developer with over 9 years of experience (2009–2019), specialised in the Spring ecosystem and the development of high-complexity systems for government and enterprise sectors.',
    about_p1:'My journey includes contributions to real-impact projects — from electronic tax systems for the Government of the State of Goiás (PAT-e), to an R&D project funded by a non-reimbursable federal grant from FINEP/Tecnova, where I developed SOAP integrations with government services and a Multitenancy SaaS login module. I also have a scientific publication accepted at the <strong>XV Brazilian Congress on Health Informatics (CBIS 2016)</strong>.',
    about_p2:'Technically, I master Java (8–17), Spring Boot, Spring MVC, Spring Security, REST and SOAP APIs, Hibernate/JPA, Oracle and PostgreSQL, with solid CI/CD practices via GitHub Actions, Docker and testing with JUnit and Mockito.',
    about_p3:'Currently based in Sint-Niklaas, Belgium, I speak Portuguese natively, English (A2) and advanced French (C1), and I am actively reintegrating into the IT market after a period in civil construction.',
    about_location_label:'Location',
    about_edu_label:'Education',
    about_edu_value:'Systems Analysis & Development — SENAI (2015–2017)',
    about_lang_label:'Languages',
    about_lang_value:'Portuguese (native) · French C1 · English A2',
    about_pub_label:'Publication',
    about_grant_label:'R&D Grant',
    about_grant_value:'FINEP / Tecnova 2013 — Federal non-reimbursable subsidy',
nav_skills:"Stack", nav_projects:"Projects", nav_exp:"Experience", nav_contact:"Contact",
    ...
    p1_num:"001 — Destaque",
    p2_status:"● FINEP / Tecnova Grant", st_live:"● Live", st_dev:"◐ In development",
    p1_title:"PAT-e — Electronic Tax Administrative Process",
    p1_desc:"Government system for the State of Goiás (Brazil) that digitalises the entire tax administrative process between taxpayers, lawyers and the tax authority. Participated in requirements gathering, prototyping and MVP development.",
    p_view:"View project",
    p2_title:"Intelligent Social Network for Tax Management",
    p2_desc:"R&D project awarded a non-reimbursable federal grant (FINEP/Tecnova 2013). Developed SOAP integrations with government services, Multitenancy SaaS login module, technical specifications and new module development. @ Ambient Informática.",
  ...
  pt: {
    nav_skills:"Stack",     nav_about:'Sobre',
    s0_label:'// 00 — SOBRE',
    about_lead:'Desenvolvedor Java backend com mais de 9 anos de experiência (2009–2019), especializado no ecossistema Spring e no desenvolvimento de sistemas de alta complexidade para os sectores governamental e empresarial.',
    about_p1:'A minha trajectória inclui contribuições em projectos de impacto real — desde sistemas tributários electrónicos para o Governo do Estado de Goiás (PAT-e), até um projecto de I&D financiado por grant federal não-reembolsável da FINEP/Tecnova, onde desenvolvi integrações SOAP com serviços governamentais e um módulo de login Multitenancy SaaS. Tenho também uma publicação científica aceite no <strong>XV Congresso Brasileiro de Informática em Saúde (CBIS 2016)</strong>.',
    about_p2:'Tecnicamente, domino Java (8–17), Spring Boot, Spring MVC, Spring Security, APIs REST e SOAP, Hibernate/JPA, Oracle e PostgreSQL, com boas práticas de CI/CD via GitHub Actions, Docker e testes com JUnit e Mockito.',
    about_p3:'Actualmente baseado em Sint-Niklaas, Bélgica, falo português nativo, inglês (A2) e francês avançado (C1), e estou a reintegrar-me activamente no mercado de TI após um período na construção civil.',
    about_location_label:'Localização',
    about_edu_label:'Formação',
    about_edu_value:'Análise e Desenvolvimento de Sistemas — SENAI (2015–2017)',
    about_lang_label:'Idiomas',
    about_lang_value:'Português (nativo) · Francês C1 · Inglês A2',
    about_pub_label:'Publicação',
    about_grant_label:'Projeto I&D',
    about_grant_value:'FINEP / Tecnova 2013 — Subvenção federal não-reembolsável',
nav_projects:"Projetos", nav_exp:"Experiência", nav_contact:"Contato",
    ...
    p1_num:"001 — Destaque",
    p2_status:"● FINEP / Tecnova Grant", st_live:"● Em produção", st_dev:"◐ Em desenvolvimento",
    p1_title:"PAT-e — Processo Administrativo Tributário Electrónico",
    p1_desc:"Sistema governamental do Estado de Goiás (Brasil) que digitaliza todo o trâmite dos processos tributários entre contribuintes, advogados e a Secretaria da Economia. Participei no levantamento de requisitos, prototipagem e desenvolvimento do MVP.",
    p_view:"Ver projeto",
    p2_title:"Rede Social Inteligente para Gestão Fiscal",
    p2_desc:"Projeto de I&D contemplado com subsídio federal não-reembolsável (FINEP/Tecnova 2013). Integração SOAP com serviços governamentais, módulo de login Multitenancy SaaS, especificação técnica e desenvolvimento de novos módulos. @ Ambient Informática.",
  ...
  fr: {
    nav_skills:"Stack",     nav_about:'À propos',
    s0_label:'// 00 — À PROPOS',
    about_lead:'Développeur Java backend avec plus de 9 ans d\'expérience (2009–2019), spécialisé dans l\'écosystème Spring et le développement de systèmes de haute complexité pour les secteurs gouvernemental et entreprise.',
    about_p1:'Mon parcours comprend des contributions à des projets à impact réel — des systèmes fiscaux électroniques pour le Gouvernement de l\'État de Goiás (PAT-e), jusqu\'à un projet R&D financé par une subvention fédérale non remboursable FINEP/Tecnova, où j\'ai développé des intégrations SOAP avec des services gouvernementaux et un module de login Multitenancy SaaS. J\'ai également une publication scientifique acceptée au <strong>XV Congrès Brésilien d\'Informatique de Santé (CBIS 2016)</strong>.',
    about_p2:'Techniquement, je maîtrise Java (8–17), Spring Boot, Spring MVC, Spring Security, APIs REST et SOAP, Hibernate/JPA, Oracle et PostgreSQL, avec de solides pratiques CI/CD via GitHub Actions, Docker et tests avec JUnit et Mockito.',
    about_p3:'Actuellement basé à Sint-Niklaas, Belgique, je parle portugais nativement, anglais (A2) et français avancé (C1), et je me réintègre activement sur le marché informatique après une période dans la construction civile.',
    about_location_label:'Localisation',
    about_edu_label:'Formation',
    about_edu_value:'Analyse et Développement de Systèmes — SENAI (2015–2017)',
    about_lang_label:'Langues',
    about_lang_value:'Portugais (natif) · Français C1 · Anglais A2',
    about_pub_label:'Publication',
    about_grant_label:'Projet R&D',
    about_grant_value:'FINEP / Tecnova 2013 — Subvention fédérale non remboursable',
nav_projects:"Projets", nav_exp:"Expérience", nav_contact:"Contact",
    ...
    p1_title:"PAT-e — Processus Administratif Fiscal Électronique",
    p1_desc:"Système gouvernemental de l'État de Goiás (Brésil) qui numérise l'ensemble des processus administratifs fiscaux entre contribuables, avocats et l'autorité fiscale. Participation au recueil des besoins, prototypage et développement du MVP.",
    p_view:"Voir le projet",
    p2_title:"Réseau Social Intelligent pour la Gestion Fiscale",
    p2_desc:"Projet R&D lauréat d'une subvention fédérale non remboursable (FINEP/Tecnova 2013). Intégrations SOAP avec services gouvernementaux, module de login Multitenancy SaaS, spécifications techniques et développement de nouveaux modules. @ Ambient Informática.",
  ...
  nl: {
    nav_skills:"Stack",     nav_about:'Over mij',
    s0_label:'// 00 — OVER MIJ',
    about_lead:'Java backend-ontwikkelaar met meer dan 9 jaar ervaring (2009–2019), gespecialiseerd in het Spring-ecosysteem en de ontwikkeling van complexe systemen voor de overheids- en bedrijfssector.',
    about_p1:'Mijn traject omvat bijdragen aan projecten met echte impact — van elektronische belastingsystemen voor de Regering van de Staat Goiás (PAT-e), tot een O&O-project gefinancierd door een niet-terugbetaalbare federale subsidie van FINEP/Tecnova, waar ik SOAP-integraties met overheidsdiensten en een Multitenancy SaaS-loginmodule ontwikkelde. Ik heb ook een wetenschappelijke publicatie geaccepteerd bij het <strong>XV Braziliaans Congres voor Gezondheidsinformatica (CBIS 2016)</strong>.',
    about_p2:'Technisch beheers ik Java (8–17), Spring Boot, Spring MVC, Spring Security, REST- en SOAP-API\'s, Hibernate/JPA, Oracle en PostgreSQL, met solide CI/CD-praktijken via GitHub Actions, Docker en testen met JUnit en Mockito.',
    about_p3:'Momenteel gevestigd in Sint-Niklaas, België, spreek ik Portugees als moedertaal, Engels (A2) en gevorderd Frans (C1), en ik integreer me actief opnieuw in de IT-markt na een periode in de burgerlijke bouw.',
    about_location_label:'Locatie',
    about_edu_label:'Opleiding',
    about_edu_value:'Systeemanalyse & Ontwikkeling — SENAI (2015–2017)',
    about_lang_label:'Talen',
    about_lang_value:'Portugees (moedertaal) · Frans C1 · Engels A2',
    about_pub_label:'Publicatie',
    about_grant_label:'O&O Project',
    about_grant_value:'FINEP / Tecnova 2013 — Federale niet-terugbetaalbare subsidie',
nav_projects:"Projecten", nav_exp:"Ervaring", nav_contact:"Contact",
    ...
    p1_title:"PAT-e — Elektronisch Fiscaal Administratief Proces",
    p1_desc:"Overheidssysteem van de Staat Goiás (Brazilië) dat het volledige fiscale administratieve proces tussen belastingbetalers, advocaten en de belastingdienst digitaliseert. Bijgedragen aan requirementsanalyse, prototyping en MVP-ontwikkeling.",
    p_view:"Project bekijken",
    p2_title:"Intelligent Sociaal Netwerk voor Fiscaal Beheer",
    p2_desc:"O&O-project bekroond met een niet-terugbetaalbare federale subsidie (FINEP/Tecnova 2013). SOAP-integraties met overheidsdiensten, Multitenancy SaaS login-module, technische specificaties en ontwikkeling van nieuwe modules. @ Ambient Informática.",
